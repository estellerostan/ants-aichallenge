...
public:
	 ...
	 */
	std::vector<Location> BreadthFirstSearch(Location start, Location goal, SquareType searchForType = UNKNOWN, int count = 1, std::vector<Location>& exlored = std::vector<Location>()) const;
};
